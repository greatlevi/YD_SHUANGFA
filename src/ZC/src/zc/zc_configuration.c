...
void ZC_ConfigInitPara()
{
    ...
    g_struZcConfigDb.struJdInfo.u32MagicFlag  = 0xFFFFFFFF;
    memset(g_struZcConfigDb.struJdInfo.u8Feedid, 0, ZC_FEEDID_MAX_LEN);
...
{
    memcpy(g_struZcConfigDb.struJdInfo.u8Feedid, pu8FeedId, ZC_FEEDID_MAX_LEN);
    g_struProtocolController.pstruMoudleFun->pfunWriteFlash((u8*)&g_struZcConfigDb, sizeof(ZC_ConfigDB));
    g_struZcConfigDb.struJdInfo.u32MagicFlag = ZC_MAGIC_FLAG;
}
/*************************************************
